...
from src.darwin_v0.world import create_world, regenerate_resources
from src.darwin_v0.agent_simple import (
    init_params_flat, compute_param_dim, compute_state_dim,
    agent_forward_fully_flat, sample_action, mutate_params_flat
)
from src.darwin_v0.physics import (
...
from src.darwin_v0.worlds import thermotaxis, pretrain
...
class SimulationSimple:
    ...
    def step(self, state: dict, key: jax.Array) -> dict:
        ...
        if self.is_thermotaxis:
            ...
            from src.darwin_v0.worlds import temporal_gaussian
            world = temporal_gaussian.update_resource(world, state["step"], self.config)
        elif self.is_orbiting_gaussian:
            from src.darwin_v0.worlds import orbiting_gaussian
